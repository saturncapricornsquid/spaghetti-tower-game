...
canvas.addEventListener("mousedown", () => {
  ...
  if (glueMode && hit) {
    ...
    setToast("Glue applied at ends (snaps immediately). Turn Glue OFF to rotate again.");
    glueFirst = null;
  }
});
...
startBtn.onclick = () => {
  ...
  setToast("Building started. Click a stick to select it; rotate with mouse wheel or Q/E. Use Glue ON to connect ends.");
};
